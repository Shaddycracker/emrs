...
export default function AdminGallery() {
  ...
  const fetchImages = async () => {
    ...
    try {
      ...
      console.error("Error fetching gallery-photo-photo images:", error)
      toast({
        title: "Error",
        description: "Failed to load gallery-photo-photo images",
        variant: "destructive",
      })
    } finally {
      setLoading(false)
  ...
  const handleAddImage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (imageUrl) {
        ...
        toast({
          title: "Success",
          description: "Image added to gallery-photo-photo successfully",
        })
      ...
      console.error("Error adding gallery-photo-photo image:", error)
      toast({
        title: "Error",
        description: "Failed to add image to gallery-photo-photo",
        variant: "destructive",
      })
    }
  }
              ...
              <form onSubmit={handleAddImage} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                        type="button"
                        variant="outline"
                        onClick={() => document.getElementById("gallery-photo-photo-image")?.click()}
                ...
                <DialogFooter>
                  <Button type="submit" disabled={!imageFile || uploadingImage}>
                    {uploadingImage ? "Uploading..." : "Add to gallery-photo-photo"}
                  </Button>
                </DialogFooter>
              </form>
            </DialogContent>
              ...
              <Card key={image.id} className="overflow-hidden">
                <div className="aspect-square relative">
                  <img
                      ...
                      alt={image.description || "gallery-photo-photo image"}
